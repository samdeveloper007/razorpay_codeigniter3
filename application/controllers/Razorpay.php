...
class Razorpay extends CI_Controller {
	...
	public function checkout() {
        ...
        $data['callback_url']       = base_url().'index.php/Razorpay/callback';
        $data['surl']               = base_url().'index.php/Razorpay/success';;
        $data['furl']               = base_url().'index.php/Razorpay/failed';;
    ...
    private function curl_handler($payment_id, $amount)  {
        ...
        $key_id         = "rzp_test_EeEUMdlcaZxv1W";
        $key_secret     = "ENvyT78lhHhw7u9oEJhueBG6";
